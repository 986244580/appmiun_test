...
//        WebElement textView = driver.findElement(By.xpath("//*[@id='com.example.test:id/tv_main']"));
        WebElement textView = driver.findElement(By.id("com.example.test:id/tv_main"));
